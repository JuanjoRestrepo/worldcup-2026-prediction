...
Intended use (one-off, after a retrain cycle):
    ...
    from backend.modeling.reporting_comparison import generate_comparison_report
    ...
    *,
    ...
    lines: list[str] = [
        ...
        *_segment_table(v1_conf_segs, v2_conf_segs, _CONFEDERATION_ORDER),
        ...
        "---",
        "",
        "_Report generated automatically by `backend/modeling/reporting_comparison.py`._",
    ]
