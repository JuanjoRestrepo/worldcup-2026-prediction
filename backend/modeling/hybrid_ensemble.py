...
✓ RECOMMENDED: Use backend.modeling.hybrid_ensemble_segment_aware.SegmentAwareHybridDrawOverrideEnsemble
...
class HybridDrawOverrideEnsemble(ClassifierMixin, BaseEstimator):  # type: ignore[misc]
